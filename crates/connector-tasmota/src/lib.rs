...
pub use connector::{
    setup_guide, TasmotaConnector, ACTION_SET_POWER, CAPABILITY_READ_ENERGY,
    CAPABILITY_READ_POWER_STATE, CAPABILITY_READ_UPTIME, CAPABILITY_READ_WIFI_SIGNAL,
    CAPABILITY_SET_POWER, DATA_POINT_CURRENT_AMPS, DATA_POINT_ENERGY_TODAY_KWH,
