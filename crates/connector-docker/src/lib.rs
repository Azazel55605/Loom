...
pub use connector::{
    ...
    DATA_POINT_IMAGE_REF, DATA_POINT_LOGS, DATA_POINT_MEMORY_HISTORY,
    ...
    DATA_POINT_UPTIME, DISPLAY_NAME, HISTORY_CAPACITY, ICON, LOG_TAIL_LINES, RESOURCE_KIND_UPDATES,
    TYPE_ID,
};
