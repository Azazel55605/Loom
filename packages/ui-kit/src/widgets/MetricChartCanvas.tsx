...
function MetricChartTooltip({
  ...
  return (
    <div className="chart-tooltip motion-content-reveal surface-elevated min-w-24 rounded-md border border-border px-3 py-2 text-xs text-popover-foreground shadow-md">
