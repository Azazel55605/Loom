    ...
    >
      {options.map((option) => (
        <RadioGroupPrimitive.Item
          ...
          value={option.value}
          className={cn(
            "inline-flex min-h-[var(--touch-target-size)] min-w-[var(--touch-target-size)] items-center justify-center gap-2 whitespace-nowrap rounded-md px-3 py-1.5 text-sm font-medium transition-colors",
